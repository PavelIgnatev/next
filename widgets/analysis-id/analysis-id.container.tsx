...
export const AnalysisIdContainer = () => {
  ...
  const {
    ...
    Верни только одно ответное сообщение к пользователю Павел, в котором будет содержаться основаная часть-отсылка на последнее сообщение с наводящим вопросом для продолжения общения.
    # Евгений:`),
    {
      onSuccess: (content) => {
        setMessages((p) => {
