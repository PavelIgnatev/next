      ...
      makeRequestGPT([
        {
          ...
          ЦЕЛЬ ДИАЛОГА:  ${
            ...
            dialogue.filter((e) => e.role === "user").length > 1
              ? analysisData.goal
              : `ответить на вопрос от юзера, после чего рассказать про ОПИСАНИЕ КОМПАНИИ и спросить у юзера было бы ему интересно узнать о предложении ОПИСАНИЕ КОМПАНИИ.`
          }
