      ...
      makeRequestGPT([
        {
          ...
          ЦЕЛЬ ДИАЛОГА:  ${
            ...
            dialogue.filter((e) => e.role === "user").length > 1
              ? analysisData.goal
              : `Поблагодари юзера за ответ, если он задал вопрос - ответь, а дальше расскажи про ОПИСАНИЕ КОМПАНИИ, после чего спроси у юзера было бы ему интересно узнать больше о ОПИСАНИЕ КОМПАНИИ.`
          }
