      ...
      makeRequestGPT([
        {
          ...
          ЦЕЛЬ ДИАЛОГА:  ${
            ...
            dialogue.filter((e) => e.role === "user").length > 1
              ? analysisData.goal
              : `поблагодарить юзера за ответ, ответить на его вопрос (если он есть), а дальше рассказать чем занимается ОПИСАНИЕ КОМПАНИИ и спросить было бы ему интересно узнать больше о ОПИСАНИЕ КОМПАНИИ`
          }
